 ...
 * @param {string} key - Private key in nsec or hex format
 ...
 * @param {string} key - Public key in npub or hex format
 ...
 * @param {boolean} asNpub - Whether to return as npub format
 * @returns {string} - Formatted public key
 */
export function formatPublicKey(pubkey, asNpub = false) {
  if (!pubkey) return '';
